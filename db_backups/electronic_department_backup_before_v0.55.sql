...
CREATE TABLE `grades` (
  ...
  `grade_type` enum('CURRENT','MODULE','MIDTERM','FINAL','RETAKE','MAKEUP') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `grades` VALUES (1,NULL,'2025-08-29 12:27:09.892049','2025-08-29 12:27:09.891641','MODULE',63,NULL,'2025-09-01 09:12:54.138673',1,1,1),(2,NULL,'2025-08-29 12:27:09.894675','2025-08-29 12:27:09.894506','MIDTERM',65,NULL,'2025-09-01 08:47:04.929745',1,1,1),(3,'Задовільна робота, потребує покращення','2025-08-29 12:27:09.896502','2025-08-29 12:27:09.896336','CURRENT',78,_binary '\0','2025-08-29 12:27:09.896511',2,1,1),(4,'Покращення результатів на екзамені','2025-08-29 12:27:09.898258','2025-08-29 12:27:09.898090','FINAL',82,_binary '','2025-08-29 12:27:09.898269',2,1,1),(9,'Тестова оцінка','2025-09-01 08:26:06.450640','2025-09-01 08:26:06.449089','CURRENT',85,_binary '\0','2025-09-01 08:26:06.450647',4,4,1),(10,'Модульна оцінка','2025-09-01 08:26:30.188674','2025-09-01 08:26:30.188456','MODULE',90,_binary '\0','2025-09-01 08:26:30.188683',4,4,1),(11,'тест','2025-09-01 08:32:55.304471','2025-09-01 08:32:55.304110','RETAKE',42,_binary '\0','2025-09-01 08:32:55.304501',6,3,1),(12,'тест','2025-09-01 08:34:07.994168','2025-09-01 08:34:07.994023','RETAKE',65,_binary '\0','2025-09-01 08:34:07.994174',1,4,1),(13,NULL,'2025-09-01 08:41:43.452343','2025-09-01 08:41:43.450686','FINAL',87,_binary '\0','2025-09-01 08:41:43.452351',4,2,1);
...
CREATE TABLE `subjects` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `assessment_type` enum('EXAM','CREDIT','DIFFERENTIATED_CREDIT','COURSE_WORK','COURSE_PROJECT') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime(6) DEFAULT NULL,
...
CREATE TABLE `teachers` (
  ...
  `biography` tinytext COLLATE utf8mb4_unicode_ci,
  `created_at` datetime(6) DEFAULT NULL,
  `department_position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hire_date` datetime(6) DEFAULT NULL,
  `is_active` bit(1) DEFAULT NULL,
  `office_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scientific_degree` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
  `user_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `users` (
  ...
  `role` enum('ADMIN','MANAGER','TEACHER','STUDENT','GUEST') COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_at` datetime(6) DEFAULT NULL,
