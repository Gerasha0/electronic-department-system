...
### История релизов:
- **v0.8.3** - Массовые багфиксы и улучшения интерации с группами, студентами и оценками: устранены ошибки отображения и прав для кнопок на страницах дисциплин и групп, добавлены недостающие значения форм навчання, исправлены фильтры по рівню освіти и формам навчання. Обновлена логика добавления студентов в группы, автоматическое присвоение и обновление параметров студентов при изменении группы, предупреждение при конфликте данных. Устранены ошибки при добавлении, редактировании и удалении оценок, корректно работает архив. Удаление группы больше не удаляет студентов — теперь они отвязываются и остаются в списке. Удалены устаревшие модальные окна архивных студентов, исправлены ошибки синхронизации отображения студентов. Исправлены 3 автотеста, повышена стабильность и согласованность данных по всей системе.
